  ...
  module.directive('gaTimeSelectorBt', function($rootScope, gaTime) {
    return {
      ...
      templateUrl: 'geoadmin-module/components/timeselector/partials/timeselector-bt.html',
      scope: {
  ...
  module.directive('gaTimeSelector', function(gaDebounce, gaTime,
    ...
    return {
      restrict: 'A',
	  //define a local relative url
      templateUrl: 'geoadmin-module/components/timeselector/partials/timeselector.html',
      scope: {
